...
// ローカル定数
//-----------------------------------------------------------------------------------------------------------------------------------------
const CONTENT_TYPES_ARY: [&str; 69] = ["text/html","text/css","text/xml","image/gif","image/jpeg","application/x-javascript","application/atom+xml",
"application/rss+xml","application/font-woff2","application/x-font-ttf","text/mathml","text/plain",
...
"application/pdf","application/postscript","application/rtf","application/vnd.ms-excel",
"application/vnd.ms-powerpoint","application/vnd.wap.wmlc","application/vnd.google-earth.kml+xml",
"application/vnd.google-earth.kmz","application/x-7z-compressed","application/x-cocoa",
"application/x-java-archive-diff","application/x-java-jnlp-file","application/x-makeself","application/x-perl",
"application/x-pilot","application/x-rar-compressed","application/x-redhat-package-manager","application/x-sea",
"application/x-shockwave-flash","application/x-stuffit","application/x-tcl","application/x-x509-ca-cert",
"application/x-xpinstall","application/xhtml+xml","application/zip","application/wasm","audio/midi",
"audio/mpeg","audio/ogg","audio/x-m4a","audio/x-realaudio","video/3gpp","video/mp4","video/mpeg",
"video/quicktime","video/webm","video/x-flv","video/x-m4v","video/x-mng","video/x-ms-asf","video/x-ms-wmv",
"video/x-msvideo"
];
const EXTENS_ARY: [&str; 69] = ["html","css","xml","gif","jpg","js","atom","rss","woff2","ttf","mml","txt","jad","wml","htc","png","tiff","wbmp",
"ico","jng","bmp","svg","webp","jar","json","hqx","doc","pdf","ps","rtf","xls","ppt","wmlc","kml","kmz","7z","cco","jardiff",
"jnlp","run","pl","prc","rar","rpm","sea","swf","sit","tcl","der","xpi","xhtml","zip","wasm","mid","mp3","ogg","m4a","ra","3gpp","mp4",
"mpeg","mov","webm","flv","m4v","mng","asf","wmv","avi"
];
...
mod tests {
    ...
    fn test_hashout_hashverify() {
        ...
        assert!(seg4_common::hashverify("abcdefghijk","$2b$10$CE017CK0psCSUCKs/Xr2EufqFGmKDDQmFVFT/xHCToU.L4IVGz40O"));
    }   
    #[test]
